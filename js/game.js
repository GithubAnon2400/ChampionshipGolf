class Game {
    ...
    initGame() {
        ...
        this.setupMultiplayer(); // Moved here after generateCourse
    ...
    setupMultiplayer() {
        if (!this.course || !this.course.holes || this.course.holes.length === 0) {
            console.warn('Course not ready for multiplayer setup, retrying after delay');
            setTimeout(() => this.setupMultiplayer(), 1000);
            return;
        }
